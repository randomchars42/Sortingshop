...
setup(
    ...
    url='htttps//github.com/randomchars42/sortingshop',
    project_urls={
        'Documentation': 'htttps//github.com/randomchars42/sortingshop',
        'Funding': '',
        'Say Thanks!': '',
        'Source': 'htttps//github.com/randomchars42/sortingshop',
